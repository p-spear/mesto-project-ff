...
const { CleanWebpackPlugin } = require('clean-webpack-plugin'); // подключите плагин clean-webpack-plugin
...
module.exports = {		// module.exports — это синтаксис экспорта в Node.js 
	...
	plugins: [ // добавьте массив
		...
		new CleanWebpackPlugin(), // использовали плагин clean-webpack-plugin
